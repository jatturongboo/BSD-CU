                ...
                <nav class="navbar navbar-default navbar-fixed">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">คันเบ็ดตกปลาทั้งหมด</a>
									...
									FROM `registers`";
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        echo '<td class="text-center"><a href="enrollee_check.php?id='. base64_encode($row["id"]).'" title="แก้ไขข้อมูล/ตรวจสอบ"><span class="glyphicon glyphicon-edit" style="margin-left: 3px; margin-right: 3px;"></span></a></td>';
                                                        echo "</tr>";
                                                        $i++;
                                                    }
                                                } else {
