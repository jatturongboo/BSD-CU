                        ...
                        <form name='recommend' action="">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-checkbox">
                                    <input type="radio" name="experience" value="0" id="experience0" >
                                    <label class="font-weak" for="experience0">ยังไม่เคยตกปลามาก่อน</label> &nbsp;&nbsp;
                                    <input type="radio" name="experience" value="1" id="experience1" >
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="input-checkbox">
                                    ...
                                    <label class="font-weak" for="fishing_grounds0">น้ำตก</label>
